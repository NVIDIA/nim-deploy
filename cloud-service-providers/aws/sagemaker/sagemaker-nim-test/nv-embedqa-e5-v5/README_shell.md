...
In this example we show how to build & deploy an AWS Sagemaker-compatible NIM image for via AWS CLI and shell commands.
...
export SRC_IMAGE_PATH=nvcr.io/nim/nvidia/nv-embedqa-e5-v5:latest
...
export SG_MODEL_NAME="nvidia/nv-embedqa-e5-v5"
