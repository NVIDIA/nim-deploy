...
Hands-on workshops for deploying NVIDIA AI Blueprints and NIM on Oracle Cloud Infrastructure (OCI), including Oracle Kubernetes Engine (OKE) and OCI Data Science.
...
| [NIM on Data Science](NIM%20on%20Data%20Science%20Workshop.md) | Deploy NVIDIA NIM on OCI Data Science Service | 60-75 min | 1 H100 / 2 A100 |
...
Deploy NVIDIA NIM (Inference Microservices) on OCI Data Science Service. This workshop teaches you how to:

- Create a Data Science project and model artifact
- Deploy an NVIDIA NIM using a custom container and capacity reservation
- Run inference against the deployed NIM (e.g., Llama 3)

Uses OCI Cloud Shell and Python; no OKE/kubectl/Helm required.
