...
For a **light smoke run**, use **`--concurrency 1`** and a small **`--request-count`** (the examples use **10**). Set **`--input-file`** to the path of your **`mooncake_trace.jsonl`**.
